"""
Django settings for crm_backoffice project.
...
SECRET_KEY = 'django-insecure-9-(h=0mc)m6dkv@z-s02$kzw307eqt=+ncm5&#mjfe30lb3jef'
...
WSGI_APPLICATION = 'crm_backoffice.wsgi.application'
